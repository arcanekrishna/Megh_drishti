...
flowchart TB
    subgraph Multi_Modal_Inputs [Multi-Modal Ingestion Grid]
        A["ERA5 Cloud / Satellite Proxy\n- Cloud Base Drop Rate (Lift)\n- Total Column Water Vapor\n- Precipitation Rate"]
        B["Atmospheric Thermodynamics (Copernicus ERA5)\n- CAPE & CIN Profiles\n- 10m & 850hPa Wind Shear\n- Temperature"]
        C["High-Res Topography\n- Elevation (m)\n- Slope (degrees)\n- Runoff Drainage Basins"]
    end
    ...
    subgraph Deep_Backbone [Shared Spatiotemporal Backbone]
        E["ConvGRU Temporal Encoder +\nSpatiotemporal Residual CNN\nwith Spatial Attention Gate"]
    end
...
| **Spatial Resolution** | 12km to 3km | **0.25° to 0.04°** | Hyper-local tracking |
